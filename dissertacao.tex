...
\part{WhatWeeeAre: jogo eletrônico com abordagem à reciclagem de resíduos eletrônicos}
\include{capitulos/whatweeeare}
\include{capitulos/storyline}
\include{capitulos/componentes}
